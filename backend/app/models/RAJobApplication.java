...
public class RAJobApplication extends Model{
    @Id
    ...
    public RAJobApplication(String applyHeadline) {
    ...
    public static Finder<Long, RAJobApplication> find =
            new Finder<Long, RAJobApplication>(RAJobApplication.class);
