...
(function($, window) {
  ...
  Starrs = (function() {
    ...
    //  Starrs.prototype.getStars = function() {
    //   var starrs = this.$el[0];
    //   var _this = this;
    //   var url = "/climateService/updateRating/serviceId/"+$(starrs).attr("data-field")+"/"+$(starrs).attr("data-sid");
    //   $.getJSON(url, {}, function(data) {
    //     console.log(data);
    //     if(data.rate) {
    //       _this.options.rating = data.rate;
    //       _this.syncRating(data.rate);
    //     }
    //   })
    // }
...
//      }
    	if (!this.options.rating) {
    	      ...
    	      var starrs = $(".starrs")[0];
    	      var url = "/app/updateRating/serviceId/"+$(starrs).attr("data-sid")+"/rate/"+rating;
    	      $.getJSON(url, {}, function(data){
