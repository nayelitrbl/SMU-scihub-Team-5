...
public class AuthorService {
    ...
    /**
     * This method intends to create a json from a Author form.
     *
     * @param userForm given user form
     * @return json of user's information
     */
    public ObjectNode createJsonFromAuthorForm(Form<Author> userForm) {
    ...
    /**
     * This method renders the author list page.
     *
     ...
     */
    public Result renderAuthorListPage(JsonNode userListJsonNode, boolean isCallerMySpacePage, int pageLimit,
        ...
        try {
            ...
            return ok(authorList.render(users,
